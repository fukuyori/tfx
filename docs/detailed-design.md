...
When the built-in terminal pane is visible, the window content minimum height includes both the main file area minimum height and the terminal pane minimum height, so resizing the window cannot collapse either area below its usable floor.
